...
image_path = grab_screen() #함수호출이라 () 괄호 필요
...
##############################################################################################################################################################
        ...
        lane_viz = cv2.addWeighted(cv2.resize(image_vis, (1280, 720)), 0.7, cv2.resize(mask_image, (1280, 720)), 0.5, 0)
...
if __name__ == '__main__':
    ...
    main_autonomous_loop(weights_path) #수정한 것
